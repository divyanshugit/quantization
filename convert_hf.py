# Src: https://github.com/ggerganov/llama.cpp/blob/master/convert_hf_to_gguf.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--outtype",
        type=str,
        choices=["f32", "f16", "bf16", "q8_0", "auto", "q4_k_m"],
        default="f16",
...
# python convert_hf.py llama-3.1.-8b-instruct  --outfile llama_3.1_q8_0.gguf --outtype q8_0
